...
ROOT_URLCONF = 'easy_deployment.urls'
...
WSGI_APPLICATION = 'easy_deployment.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.getenv('DB_NAME', 'vercel_clone'),
...
DEPLOYMENT_DOMAIN = os.getenv('DEPLOYMENT_DOMAIN', 'localhost')
NGINX_PROXY_NETWORK = os.getenv('NGINX_PROXY_NETWORK', 'web')
